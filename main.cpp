...
int main() {
    ...
    cout << pic << endl;
    cout << fpic << endl;
    cout << frame( fpic ) << endl;
    
    const Picture& pic2 = Picture( joju, 3 );
    cout << pic2 << endl;
    cout << frame( (frame(pic2) & frame(pic))) << endl;
    cout << frame( pic2 & pic) << endl;
    
    cout << (pic | fpic) << endl;
    cout << (pic & fpic) << endl;
    cout << frame( pic | fpic) << endl;
    cout << frame( pic & fpic) << endl;
    
    const Picture fppf = frame( frame( pic & (pic | fpic)));
    cout << fppf << endl;
    cout << reframe( fppf, '+', '|', '-' ) << endl;
